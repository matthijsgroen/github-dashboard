      ...
      <div className="max-w-2xl mx-auto pt-8 p-4">
        ...
        >
          <input
            ...
            className="w-full max-w-md px-4 py-2 text-gray-700 dark:text-gray-100 border border-gray-300 dark:border-gray-600 
          ...
          <button
            ...
            className="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-700 
                     ...
                     focus:ring-offset-2 disabled:bg-blue-300 disabled:cursor-not-allowed 
